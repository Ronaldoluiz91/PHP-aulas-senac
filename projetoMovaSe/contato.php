            ...
            <article class="cont-contato">
                ...
                if(isset($_POST['enviar'])){
                    ...
                    if(!empty($_POST['nome']) && !empty($_POST['email']) && !empty($_POST['telefone']) && !empty($_POST['assunto']) && !empty($_POST['mensagem']) ){
                        ...
                        $sql = "INSERT INTO contato_tbl (nome_contato, email_contato, celular, assunto_contato, mensagem_contato, data)";
                        $sql .="VALUES('{$nome}', '{$email}', '{$celular}', '{$assunto}', '{$mensagem}', '{$data}')";
                            
                     //verificação de possiveis erros na conexão ou na query
                     ...
                     <?php
                        ...
                        <p><a href="contato.php"> Volte para o formulario </a>  </p>
                    ...
                    <form action="" id="form-contato" method="post" >
                        ...
                        <p>
                            ...
                            <textarea tabindex="9" required type= "mensagem" name="mensagem" id="mensagem" cols="30" rows="6"></textarea>
                        </p>
                        <p>
